...
CREATE UNIQUE INDEX tenant_pkey ON public.tenants USING btree (id);
...
alter table "public"."tenants" add constraint "tenant_pkey" PRIMARY KEY using index "tenant_pkey";
...
alter table "public"."tenant_permissions" add constraint "tenant_permissions_service_user_fkey" FOREIGN KEY (service_user) REFERENCES service_user(id) not valid;
